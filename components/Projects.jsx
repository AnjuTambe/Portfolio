...
const projects = [
	{
		...
		description:
			"Built an E-Commerce app using MERN stack, boosting user engagement by 15%. Implemented JWT for secure user authentication, enhancing data access control by 30%. Optimized search, filter, and sort functionalities to enhance the checkout experience, increasing user engagement metrics by 20%.",
		tags: ["MERN Stack", "JWT"],
		code: "https://github.com/AnjuTambe/EcommerceApp",
	},
	{
	...
	},
	{
		...
		description:
			"Developed an AI-powered sentiment analyzer using Streamlit, Python, and NLP to extract insights from NVIDIA's quarterly earnings calls. Implemented sentiment and keyword trend analysis across multiple transcripts and visualized the results using interactive dashboards. Automated parsing of RTF transcripts into structured JSON format, enabling efficient comparison of tone shifts and strategic focus across quarters.",
	...
	},
	{
		...
		description:
			"Developed an end-to-end AI assistant using FastAPI backend and HTML/JS frontend to coordinate multi-agent workflows for search, calendar, checklist, and email tasks. Implemented Planner, Calendar, Checklist, Search, Memory, and Email agents with Google Calendar and SendGrid integration, supporting agent chaining and memory recall. Designed modular architecture with real-time task execution, agent response logging, and extensible agent APIs for future enhancements like Pinecone, Next.js frontend, and LLM integration.",
		tags: ["FastAPI", "JavaScript", "Google Calendar", "SendGrid"],
					...
					{projects.map((proj, idx) => (
						...
						>
							...
							<a
								...
								className={`mt-2 px-4 py-2 rounded-full ${colorClassMap[proj.color].bg} text-white font-semibold ${colorClassMap[proj.color].hover} transition-colors`}
							>
								View Code
							</a>
						</div>
					...
					>
						...
						>
							...
							<a
								...
								target="_blank"
								rel="noopener noreferrer"
								className={`px-4 py-2 rounded-full bg-white ${colorClassMap[projects[activeIdx].color].text} font-semibold hover:bg-gray-200 transition-colors`}
							>
								View Code
							</a>
						</div>
